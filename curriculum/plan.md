...
| [x] | 3 | string·빈도 배열·문자열 파싱 연습 | [프로그래머스 · 문자열을 정수로 바꾸기](https://school.programmers.co.kr/learn/courses/30/lessons/12925) · [프로그래머스 · 이상한 문자 만들기](https://school.programmers.co.kr/learn/courses/30/lessons/12930) · [후보 3개 중 2개 해결](pools.md#week-1-day-3) | 4 | 0 |
...
| 완료 | Day | Daily 목표 | 지정 문제·실행 내용 | 신규 | 재풀이 |
|---|---|---|---|---:|---:|
| [x] | 1 | 직접 만든 스택과 std::stack 비교·괄호 검사 | [LeetCode · Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) · [프로그래머스 · 올바른 괄호](https://school.programmers.co.kr/learn/courses/30/lessons/12909) · [후보 3개 중 2개 해결](pools.md#week-2-day-1) | 4 | 0 |
